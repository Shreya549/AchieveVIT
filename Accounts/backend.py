...
class JWTFacultyAuthentication(authentication.BaseAuthentication):
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = Faculty.objects.get(pk=payload['id'])
        except Faculty.DoesNotExist:
            # msg = 'No  matching this token was found.'
            return
            #raise exceptions.AuthenticationFailed(msg)
...
class JWTHRAuthentication(authentication.BaseAuthentication):
    authentication_header_prefix = 'Token'
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = HR.objects.get(pk=payload['id'])
